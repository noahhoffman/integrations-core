...
STATS_METRICS = {  # Metrics that are common to all Elasticsearch versions
    ...
    "elasticsearch.thread_pool.flush.completed": ("rate", "thread_pool.flush.completed"),
    ...
    "elasticsearch.thread_pool.generic.completed": ("rate", "thread_pool.generic.completed"),
    ...
    "elasticsearch.thread_pool.get.completed": ("rate", "thread_pool.get.completed"),
    ...
    "elasticsearch.thread_pool.index.completed": ("rate", "thread_pool.index.completed"),
    ...
    "elasticsearch.thread_pool.management.completed": ("rate", "thread_pool.management.completed"),
    ...
    "elasticsearch.thread_pool.refresh.completed": ("rate", "thread_pool.refresh.completed"),
    ...
    "elasticsearch.thread_pool.search.completed": ("rate", "thread_pool.search.completed"),
    ...
    "elasticsearch.thread_pool.snapshot.completed": ("rate", "thread_pool.snapshot.completed"),
    ...
    "elasticsearch.thread_pool.warmer.completed": ("rate", "thread_pool.warmer.completed"),
